	...
	render() {
		return (
			<main className="mainpage">
				...
				<p>Здесь я буду вести небольшой блог о жизни в мире АлО – заметки, которые, надеюсь, будет интересно почитать другим игрокам. Сохранять важные, на мой взгляд, исторические события на временной шкале, а так же работать над некоторыми другими полезными околоигровыми сервисами.</p>
